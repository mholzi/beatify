...
### Changed
- **Title & Artist: typo tolerance scales with title length.** The fuzzy auto-accept budget now grows with the title instead of a flat number — 3 edits for short titles (5-11 chars), 4 for 12+, 5 for 20+. So "Smels Like Ten Sprit" auto-counts for "Smells Like Teen Spirit", while titles under 5 chars still require an exact match (#1180).
